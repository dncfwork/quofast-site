...
(function () {
  ...
  var STRINGS = {
    en: {
      'meta.title': 'QuoFast — Quotation & Invoice App for Malaysian Small Businesses',
      ...
      'hero.eyebrow': 'Made for small businesses',
      'hero.title': 'Quote on the spot. Invoice when it\u2019s done.',
      ...
      'alt.quote': 'QuoFast quotation preview for an RM 8,460 job',
      ...
      'how.s1.text': 'Pick a client from your phone contacts and list what you are charging for — work, hours or materials — with quantity and unit price.',
      ...
      'faq.a3': 'No. Freelancers and one-person businesses use QuoFast too. SST settings are optional.',
      ...
      'tools.title': 'Free tools, no sign-up',
      'tools.sub': 'Need one document right now? Make it in your browser — no account, no watermark, nothing uploaded.',
      'tools.quote.title': 'Quotation generator',
      'tools.quote.sub': 'A professional sebut harga with SST and RM totals, ready to download as a PDF.',
      'tools.invoice.title': 'Invoice generator',
      'tools.invoice.sub': 'The same format for after the job, with your bank details and any deposit already paid.',
      'tools.open': 'Open',
    ...
    ms: {
      'meta.title': 'QuoFast — Aplikasi Sebut Harga & Invois untuk Perniagaan Kecil Malaysia',
      ...
      'hero.eyebrow': 'Dibina untuk perniagaan kecil',
      'hero.title': 'Sebut harga di tempat. Invois bila kerja siap.',
      ...
      'alt.quote': 'Pratonton sebut harga QuoFast bernilai RM 8,460',
      ...
      'how.s1.text': 'Pilih pelanggan daripada kenalan telefon dan senaraikan apa yang anda caj — kerja, jam atau bahan — dengan kuantiti dan harga seunit.',
      ...
      'faq.a3': 'Tidak. Pekerja bebas dan perniagaan seorang diri juga menggunakan QuoFast. Tetapan SST adalah pilihan.',
      ...
      'nav.tools': 'Alat percuma',
      'tools.title': 'Alat percuma, tanpa daftar',
      'tools.sub': 'Perlukan satu dokumen sekarang? Buat terus dalam pelayar — tiada akaun, tiada tera air, tiada apa-apa dimuat naik.',
      'tools.quote.title': 'Penjana sebut harga',
      'tools.quote.sub': 'Sebut harga profesional dengan SST dan jumlah RM, sedia dimuat turun sebagai PDF.',
      'tools.invoice.title': 'Penjana invois',
      'tools.invoice.sub': 'Format yang sama untuk selepas kerja siap, dengan butiran bank dan deposit yang telah dibayar.',
      'tools.open': 'Buka',
    ...
    zh: {
      'meta.title': 'QuoFast — 马来西亚小生意的报价单和发票 App',
      ...
      'alt.quote': 'QuoFast 报价单预览：一份 RM 8,460 的报价',
      ...
      'how.s1.title': '填写工程',
      'how.s1.text': '从手机通讯录选客户，列出你要收的项目——工程、工时或材料——填上数量和单价。',
      'how.s2.title': '换上你的门面',
      ...
      'faq.a3': '不用。自由职业者、一人公司也在用。SST 设置可开可关。',
      ...
      'nav.tools': '免费工具',
      'tools.title': '免费工具，不用注册',
      'tools.sub': '现在就要一张单？直接在浏览器里做 —— 不用开账号、没有水印、什么都不会上传。',
      'tools.quote.title': '报价单生成器',
      'tools.quote.sub': '专业格式的报价单，含 SST 和马币总额，直接下载 PDF。',
      'tools.invoice.title': '发票生成器',
      'tools.invoice.sub': '同样的格式，做完工用，可以填银行资料和已收的订金。',
      'tools.open': '打开',
      'footer.quote': '报价单生成器',
