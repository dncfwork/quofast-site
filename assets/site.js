...
(function () {
  ...
  var STRINGS = {
    en: {
      ...
      'plan.yearly.save': '≈ RM 12.50 a month — save 40%',
      'plan.cta': 'Download free',
    ...
    ms: {
      ...
      'plan.yearly.save': '≈ RM 12.50 sebulan — jimat 40%',
      'plan.cta': 'Muat turun percuma',
    ...
    zh: {
      ...
      'plan.yearly.save': '约 RM 12.50/月，省 40%',
      'plan.cta': '免费下载',
